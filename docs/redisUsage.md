...
once you log into the machine that runs redis you can use redis-cli to perform queries
...
and then you can query the file details by `redis-cli GET gudocs:111111`, example response:
